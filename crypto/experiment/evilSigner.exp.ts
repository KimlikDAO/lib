...
type SignedMessage = { r: bigint; digest: Uint8Array };

const recoverPrivateKey = (signatures: SignedMessage[]): bigint => {
...
const signer = async (privKey: bigint): Promise<SignedMessage[]> => {
