...
test("base58 ↔ hex vectors", () => {
  ...
  const shortHex =
    "000111d38e5fc9071ffcd20b4a763cc9ae4f252bb4e48fd66a835e252ada93ff480d6dd" +
    "43dc62a641155a5" satisfies LargeConstant;
  const charsetB58 =
  ...
  const allBytesHex =
    ...
    "8f9fafbfcfdfeff" satisfies LargeConstant;
  const longB58 =
    "1cWB5HCBdLjAuqGGReWE3R3CguuwSjw6RHn39s2yuDRTS5NsBgNiFpWgAnEx6VQi8csexkg" +
    "Yw3mdYrMHr8x9i7aEwP8kZ7vccXWqKDvGv3u1GxFKPuAkn8JCPPGDMf3vMMnbzm6Nh9zh1g" +
    "cNsMvH3ZNLmP5fSG6DGbbi2tuwMWPthr4boWwCxf7ewSgNQeacyozhKDDQQ1qL5fQFUW52Q" +
    "KUZDZ5fw3KXNQJMcNTcaB723LchjeKun7MuGW5qyCBZYzA1KjofN1gYBV3NqyhQJ3Ns746G" +
    "Nuf9N2pQPmHz4xpnSrrfCvy6TVVz5d4PdrjeshsWQwpZsZGzvbdAdN8MKV5QsBDY" satisfies LargeConstant;
