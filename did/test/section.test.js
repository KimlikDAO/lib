...
test("sign section", () => {
  ...
  expect(recoverSectionSigners("humanID", humanID1, vm.addr(1n))[0]).toBe(vm.addr(11n));
  expect(recoverSectionSigners("humanID", humanID2, vm.addr(1n))[0]).toBe(vm.addr(12n));

  humanID1.secp256k1.push(humanID2.secp256k1[0]);

  expect(new Set(recoverSectionSigners("humanID", humanID1, vm.addr(1n))))
